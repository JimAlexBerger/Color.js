function Color(r, g, b) {
    ...
    this.shiftLightness = function(num) {
        var hsv = this.toHSV();
        hsv.value += hsv.value + num > 100 ? 100 - hsv.value : (hsv.value + num < 0 ? -hsv.value : num);
        return this.fromHSV(hsv.hue, hsv.saturation, hsv.value);
    }

    this.setLightness = function(num) {
        var hsv = this.toHSV();
        hsv.value = num < 0 ? 0 : (num > 100 ? 100 : num);
        return this.fromHSV(hsv.hue, hsv.saturation, hsv.value);
    }

    this.shiftColor = function(degrees) {
        var shifted = this.HSVShift(this.toHSV(), degrees);
    ...
    this.name = function(){
        ntc.init();
        return ntc.name(this.toString())[1];
    }
